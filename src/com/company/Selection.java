...
public class Selection {
    ...
    public boolean contains(double x, double y) {
        return selectionGroup.getBoundsInLocal().contains(x, y);
    }
    ...
    public List<Transform> getTransforms() {
        return selectionGroup.getTransforms();
    }
    ...
    public Point2D getRotationHandlePos() {
        return new Point2D(getMidUpper().getX(), getMidUpper().getY() - 4 * padding);
    }
    ...
    public Point2D getUpperRight() {
        return new Point2D(getUpperLeft().getX() + getBounds().getWidth(), getUpperLeft().getY());
    }

    public Point2D getLowerLeft() {
        return new Point2D(getUpperLeft().getX(), getUpperLeft().getY() + getBounds().getHeight());
    }

    public Point2D getMidRight() {
        return new Point2D(getUpperLeft().getX() + getBounds().getWidth(), getUpperLeft().getY() + getBounds().getHeight() / 2);
    }

    public Point2D getMidLeft() {
        return new Point2D(getBounds().getMaxX(), getBounds().getMaxY() + getBounds().getHeight() / 2);
    }

    public Point2D getMidUpper() {
        return new Point2D(getBounds().getMaxX() + getBounds().getWidth() / 2, getBounds().getMaxY());
    }

    public Point2D getMidLower() {
        return new Point2D(getUpperLeft().getX() + getBounds().getWidth() / 2, getUpperLeft().getY() + getBounds().getHeight());
    }

    //methods to add and remove event handlers
    public void addOnDrag(EventHandler<MouseEvent> drag) {
        selectionGroup.addEventHandler(MouseEvent.MOUSE_DRAGGED, drag);
    }

    public void removeOnDrag(EventHandler<MouseEvent> drag) {
        selectionGroup.removeEventHandler(MouseEvent.MOUSE_DRAGGED, drag);
    }

    public void addOnPressed(EventHandler<MouseEvent> press) {
        selectionGroup.addEventHandler(MouseEvent.MOUSE_PRESSED, press);
    }

    public void removeOnPressed(EventHandler<MouseEvent> press) {
        selectionGroup.removeEventHandler(MouseEvent.MOUSE_PRESSED, press);
    }

    public void addOnRelease(EventHandler<MouseEvent> release) {
        selectionGroup.addEventHandler(MouseEvent.MOUSE_RELEASED, release);
    }

    public void removeOnRelease(EventHandler<MouseEvent> release) {
        selectionGroup.removeEventHandler(MouseEvent.MOUSE_RELEASED, release);
    }

    public void addOnClick(EventHandler<MouseEvent> click) {
        selectionGroup.addEventHandler(MouseEvent.MOUSE_CLICKED, click);
    }
